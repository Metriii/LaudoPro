...
namespace ApiWeb.Entities.Insalubridade
{
    ...
    {
        public List<InsaAnexos> AnexosInsa { get; set; } = new List<InsaAnexos>();

        public Insalubridade(string numeroPericia, DateTime dataPericia, DateTime dataLaudo, LocalDeTrabalho atividades, Endereco endereco) : base(numeroPericia, dataPericia, dataLaudo, atividades, endereco)
        {
        ...
        public void AddAnexos(List<InsaAnexos> anexos)
        {
            foreach(var anexo in anexos) { 
                
                AnexosInsa.Add(anexo);
            }
        }
    }
}